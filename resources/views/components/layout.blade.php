...
<body class="g-sidenav-show  bg-gray-100">
    @if (session("success"))
    <script>
        showSwal('success-message', "{{ session('success') }}")

    </script>
    @endif
    @if (session("warning"))
    <script>
        showSwal("warning-message", "{{ session('warning') }}")

    </script>
    @endif
    @if (session("error"))
    <script>
        showSwal("eror-message", "{{ session('error') }}")
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    @elseif (Request::is('book-categories'))
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Pages</a>
                            </li>
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Books Categories</li>
                        </ol>
                        <h6 class="font-weight-bolder mb-0">Categories Books</h6>
    ...
    <script>
        $(document).ready(function () {
            $('#searchInput').on('keyup', function () {
                ...
                $.ajax({
                    url: "{{ route('library.search') }}", // Sesuaikan dengan route search Anda
                    type: 'GET',
                    data: {
                        search: query
                    },
                    success: function (data) {
                        $('.row').html(data); // Update div dengan hasil pencarian
                    },
                    error: function (xhr) {
    ...
    <script src="{{ asset('admin/assets/js/soft-ui-dashboard.js') }}"></script>
</body>
