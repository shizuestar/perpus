...
document.addEventListener("DOMContentLoaded", function () {
  // Ambil data-color dari localStorage
  var savedColor = localStorage.getItem("sidebarColor");

  // Jika ada data-color yang tersimpan, set pada sidenav
  if (savedColor) {
      var sidebar = document.querySelector('.sidenav');
      sidebar.setAttribute("data-color", savedColor);

      var sidenavCard = document.querySelector('#sidenavCard');
      let sidenavCardClasses = ['card', 'card-background', 'shadow-none', 'card-background-mask-' + savedColor];
      sidenavCard.className = '';
      sidenavCard.classList.add(...sidenavCardClasses);

      var sidenavCardIcon = document.querySelector('#sidenavCardIcon');
      let sidenavCardIconClasses = ['ni', 'ni-diamond', 'text-gradient', 'text-lg', 'top-0', 'text-' + savedColor];
      sidenavCardIcon.className = '';
      sidenavCardIcon.classList.add(...sidenavCardIconClasses);

      // Tambahkan active class pada badge warna yang sesuai
      var badges = document.querySelectorAll('.badge[data-color]');
      badges.forEach(function (badge) {
          badge.classList.remove('active');
          if (badge.getAttribute('data-color') === savedColor) {
...
function sidebarColor(a) {
  ...
  // Simpan data-color ke localStorage
